#!/bin/bash
#
# ClawHub-Termux Installer
# One-liner: curl -fsSL https://raw.githubusercontent.com/mithun50/clawhub-termux/main/install.sh | bash
#
...
# Install clawhub-termux from npm
echo -e "\n${BLUE}[2/2]${NC} Installing clawhub-termux..."
...
echo "  1. Run setup:      clawhubx setup"
echo "  2. Run onboarding: clawhubx onboarding"
echo "     → Select 'Loopback (127.0.0.1)' when asked!"
echo "  3. Start gateway:  clawhubx start"
echo ""
