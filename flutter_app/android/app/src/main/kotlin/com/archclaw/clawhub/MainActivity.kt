...
class MainActivity : FlutterActivity() {
    private val CHANNEL = "com.archclaw.clawhub/native"
    private val EVENT_CHANNEL = "com.archclaw.clawhub/gateway_logs"
                ...
                "getQwenOAuthToken" -> {
                    ...
                    Thread {
                        try {
                            ...
                            runOnUiThread { result.error("QWEN_OAUTH_ERROR", e.message, null) }
                        }
                    }.start()
                }
                else -> {
