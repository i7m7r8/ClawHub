...
class _SettingsScreenState extends State<SettingsScreen> {
          ...
          : ListView(
              children: [
                ...
                ListTile(
                  ...
                  subtitle: Text(_status['clawhubInstalled'] == true
                      ? 'Installed'
                      : 'Not installed'),
                ...
                ListTile(
                  ...
                  subtitle: const Text('mithun50/clawhub-termux'),
                  leading: const Icon(Icons.code),
  ...
  Future<String> _getSnapshotPath() async {
    ...
    if (hasPermission) {
      ...
      return '$sdcard/Download/clawhub-snapshot.json';
    }
    // Fallback to app-private directory
    final dir = await getApplicationDocumentsDirectory();
    return '${dir.path}/clawhub-snapshot.json';
  }
