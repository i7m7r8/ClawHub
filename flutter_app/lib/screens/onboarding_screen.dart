...
/// Runs `clawhub onboard` in a terminal so the user can configure
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Future<void> _startOnboarding() async {
    ...
    try {
      ...
      // Replace with [..., '/bin/bash', '-lc', 'clawhub onboard']
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ClawHub Onboarding'),
