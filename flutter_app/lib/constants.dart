class AppConstants {
  static const String appName = 'ClawHub';
  static const String version = '1.8.7';
  static const String packageName = 'com.archclaw.clawhub';

  /// Matches ANSI escape sequences (e.g. color codes in terminal output).
  static final ansiEscape = RegExp(r'\x1b\[[0-9;]*[a-zA-Z]');

  static const String authorName = 'Imran';
  static const String authorEmail = 'imran@archclaw.dev';
  static const String githubUrl = 'https://github.com/i7m7r8/ClawHub';
  static const String license = 'MIT';

  static const String githubApiLatestRelease =
      'https://api.github.com/repos/i7m7r8/ClawHub/releases/latest';
  ...
  static const String channelName = 'com.archclaw.clawhub/native';
  static const String eventChannelName = 'com.archclaw.clawhub/gateway_logs';
