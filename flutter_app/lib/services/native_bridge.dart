...
class NativeBridge {
  ...
  /// Returns the raw JSON string if the token file exists, or null if not found.
  /// This allows ClawHub (and clawhub/zeroclaw/other claws) to share
  /// the OAuth token configured via `qwen auth` in Termux.
  static Future<String?> getQwenOAuthToken() async {
    return await _channel.invokeMethod('getQwenOAuthToken');
  }
}
