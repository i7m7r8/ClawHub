...
class BootstrapService {
  ...
  Future<void> runFullSetup({
    ...
    try {
      ...
      // git: clawhub has git deps (@whiskeysockets/libsignal-node)
      ...
      // Step 4: Install ClawHub (80-98%)
      _updateSetupNotification('Installing ClawHub...', progress: 82);
      onProgress(const SetupState(
