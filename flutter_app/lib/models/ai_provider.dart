...
class AiProvider {
  ...
  static const qwen = AiProvider(
    id: 'qwen',
    name: 'Qwen (OAuth)',
    description: 'Qwen Code via OAuth — FREE, no credit card',
    icon: Icons.cloud,
    ...
    apiKeyHint: 'OAuth token from Termux ~/.archclaw/',
  );

  /// All available AI providers.
  static const all = [anthropic, openai, google, openrouter, nvidia, deepseek, xai, qwen];
}
